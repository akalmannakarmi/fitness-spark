...
@update_stats(Models.Recipe, Actions.Read)
async def get_recipe(id: str, _: User = Depends(admin_user)):
...
async def get_meal_plans(
    user: User = Depends(admin_user), filters: MealPlanFilter = Depends()
):
...
@update_stats(Models.Plans, Actions.Read)
async def get_meal_pan(id: str, _: User = Depends(admin_user)):
...
async def update_meal_plan(
    id: str, form: MealPlanUpdate, _: User = Depends(admin_user)
):
